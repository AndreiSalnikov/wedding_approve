            ...
            <div className='w-full h-full'>
                <div className="bg-welcome max-w-[620px] h-full  m-auto bg-no-repeat bg-contain relative p-[30px]">
                    <div className='flex flex-col h-full max-w-[350px] m-auto'>
                        <p className='font-comic-neue text-[11px] uppercase tracking-widest text-right pt-[100px] mb-[150px]'>Вместе <br/> и
                            навсегда</p>
                        ...
                        <p className='mb-[100px] flex flex-col font-comic-neue uppercase text-[10px] tracking-widest'>Приглашаем
                            на свадьбу <span className='text-[19px] font-scriptorama lowercase'>31 мая 2024</span></p>
