                ...
                <div className='h-screen m-auto w-full transition-all'>
                    <div className='w-full h-full'>
                        ...
                        <div className='flex flex-col h-full max-w-[320px] m-auto p-5 z-10 relative text-brown'>
                            <p className='mobile-s:mb-[30px] mobile-s2:mb-[50px] mobile-s3:mb-[70px] mobile-s4:mb-[70px] font-comic-neue text-[10px] uppercase tracking-widest text-right pt-[90px] text-black'>Вместе <br/> и
                                навсегда</p>
                            <p className='mobile-s:text-[30px] mobile-s4:text-[40px] mobile-s:mb-[100px] mb-[200px] text-center font-scriptorama text-[40px] flex flex-col '>Андрей <span
