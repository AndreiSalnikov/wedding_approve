...
const config: Config = {
    ...
    theme: {
        fontFamily: {
            ...
            'scriptorama': ['Scriptorama', 'sans-serif'], 'comforta': ['Comfortaa-VariableFont_wght', 'sans-serif']
        }, extend: {
            // margin: {
            //   calc: 'calc(5vw + 10px)',
            // },
            screens: {
                ...
                brown: "rgb(89, 78, 66)", whitealpha: "rgba(255, 255, 255, 0.7)", lightbrown: "rgb(120, 107, 102)"
            },
        },
    },
    plugins: [],
